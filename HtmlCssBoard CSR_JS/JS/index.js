...
// 첫번째 방법: body 요소에 onload 이벤트 적용

// 두번째 방법: 외부스크립트일 경우 defer 속성을 적용
...
function loaded(){
    ...
    // JS에서 페이지의 변경없이 서버에서 데이터만 요청하는 기법을 AJAX
    // 이 작업을 수행해주는 내장 함수 fetch()

    // 경로주의!! JS파일 기분이 아니라 JS를 연결한 html파일의 위치를 기준으로 상대경로
    ...
    .then(function(text){
        ...
        // 데이터가 여러개이므로 반복문으로 구성 파이썬의 for in 처럼
