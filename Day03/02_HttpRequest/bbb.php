<?php
    ...
    //textarea 에서의 줄바꿈은 \n(new line)임.
    //웹 브라우저는 줄바꿈을 <br>태그를 사용해야함
    //그래서 $message 변수안에 있는 \n을 <br>태그로 변환해야함
    //php에는 이 작업을 해주는 기능(function)이 존재함
    $message= nl2br($message);


    //실무에서는 이 데이터들을 Database에 저장하는 등의 코드를 작성함
    //이 예제에서는 간단하게 데이터를 잘받았는지 확인하는 정도로
    //받은 데이터들을 사용자에게 그대로 응답해주기(브라우저에 보여주기)
